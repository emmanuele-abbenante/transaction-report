...
FROM TRANSACTIONS
WHERE COUNTERPART IN ('PENNY MARKET', 'PAM PANORAMA MI TIBALDI', 
'CDC 1070 SMA MILANO SAN G', 'UPIM SAN GOTTARDO', 'FARMACIA STAZIONE PORTA G', 
'FARMACIA MONCUCCO SNC', 'BEATO TE', 'SCARPAMONDO', 'ATLANTIC LORENTEGGIO', 
'ESSELUNGA LORENTEGGIO', 'CASH ISP 1221-MILAN', 'BANCA POP DI MILANO', 
'Gabriella Gruppi', 'MEDIAWORLD MI TROYA CC', 'LORETO ARGENTINA M12')
...
SUM(CURRENCY_AMOUNT) AS Importo
FROM TRANSACTIONS
WHERE COUNTERPART NOT IN ('PENNY MARKET', 'PAM PANORAMA MI TIBALDI', 
'CDC 1070 SMA MILANO SAN G', 'UPIM SAN GOTTARDO', 'FARMACIA STAZIONE PORTA G', 
'FARMACIA MONCUCCO SNC', 'BEATO TE', 'SCARPAMONDO', 'ATLANTIC LORENTEGGIO', 
'ESSELUNGA LORENTEGGIO', 'CASH ISP 1221-MILAN', 'BANCA POP DI MILANO', 
'Gabriella Gruppi', 'MEDIAWORLD MI TROYA CC', 'LORETO ARGENTINA M12')
